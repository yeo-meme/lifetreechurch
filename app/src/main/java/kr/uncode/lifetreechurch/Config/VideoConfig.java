...
public class VideoConfig {
    ...
    public VideoConfig() { apiService = RetrofitConfig.getInstance().getApiService(); }

    public void videoList(final ResponseCallback<YoutubeResponse> callback) {
        final Call<YoutubeResponse> task = apiService.videoList("snippet","UCVTQLxRfWz4nypo8q74iE1Q","AIzaSyD20axF8pwlVcco5B0WMa_LTZM9Cq5VcZY");
